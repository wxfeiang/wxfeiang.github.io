...
getData("http://94.191.119.191:5000/api/blog/levmsg", "get", "");
...
function submitForm(e) {
    ...
    var levmsg = {
        ...
        //  请求数据库 
    var url = `http://94.191.119.191:5000/api/blog/levmsg`;
    getData(url, "post", levmsg)
        ...
        str += ` 
        	  <li class="clearfix new-li">  
        		 <p class=" fl use-cont">
        		  ...
        		  <p class="fr new-right">${showmg[i].date.slice(0,10)}<br>
        			 ${showmg[i].userIP}
        		  </p>
        	 </li>
        `;
